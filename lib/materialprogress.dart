...
import 'package:cushion_1/offloadheatmap.dart';
...
class MaterialProgressWidgetState extends State<MaterialProgressWidget>
 ...
 final MaterialProgressController materialProgressController = Get.put(MaterialProgressController());
    ...
    onPopInvoked: (didPop) async {
          ...
          builder: (context, constraints) {
            ...
            if (isTab) {
              return  Obx(
                ()=> IndexedStack(
                  // index: selectedIndex,
                     index: materialProgressController.selectedIndex.value,
                  children: <Widget>[
                    Row(
                      children: [
                        Expanded(
                ...
                child:  UserListPage(), // Replace with your AddUserPage widget
                          ...
                          children: [
                            Expanded(
                child:  OffloadHeatmapWidget(), // Replace with your AddUserPage widget
                            ),
                          ],
                        ),
                  ],
         ...
         textStyle: const TextStyle(
           ...
           fontSize: 16,
                ...
                // selectedIndex: selectedIndex,
                 selectedIndex: materialProgressController.selectedIndex.value,
                onTabChange: (index) {
                  setState(() {
                    // selectedIndex = index;
                     materialProgressController.setIndex(index);
                  });
                },
              ),
            ),
       ...
       color: AppColors.bgLight,
        ...
        children: [
         ...
         height: 24,  // Set the height of the image
                ...
                onTap: () {
                  Navigator.pop(context);
                 // showSetReminderDialog(context); 
                  materialProgressController.setIndex(4); 
        //          setState(() {
        // // selectedIndex = 4; // Index of your Add User fragment
        ...
        //    });
         ...
         onTap: () {
        //    setState(() {
        // selectedIndex = 6; // Index of your Switch User fragment
        //    });
           Navigator.pop(context); 
               materialProgressController.setIndex(6); // Close the drawer
         },
       ),
        ...
        title: const Text('View PDF'),
                ...
                onTap: () {
                Navigator.pop(context);
                  materialProgressController.setIndex(5); 
                 // showSetReminderDialog(context); 
        //          setState(() {
        // selectedIndex = 5; // Index of your Add User fragment
        //    });
                },
           ),
         ),
